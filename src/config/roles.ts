    ...
    },
    {
        ...
        features: [
            ...
            },
            {
                ...
                flow: "Vào Trường & Phân hiệu → tab Nhân sự → Thêm/Cập nhật hồ sơ → theo dõi theo tổ hoặc trạng thái.",
                iconKey: "personnel",
            },
            {
                key: "schools",
                ...
                flow: "Vào Trường & Phân hiệu → quản lý trường/cơ sở → cập nhật danh mục.",
                iconKey: "school",
            },
        ],
    },
    {
        ...
        features: [
            ...
            },
            {
                ...
                flow: "Vào Trường & Phân hiệu → tab Khối & tổ → xem thành viên của tổ → cập nhật phân công.",
                iconKey: "sector",
            },
        ],
    },
    {
        ...
        features: [
            ...
            },
            {
                ...
                title: "Khối & tổ",
                path: "/operations/schools?tab=sectors",
                flow: "Vào Trường & Phân hiệu → tab Khối & tổ → cập nhật tổ chuyên môn và phân công.",
                iconKey: "sector",
            },
            {
                key: "reports",
