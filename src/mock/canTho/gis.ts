...
const campuses: GisCampus[] = [
    { id: "campus-main", schoolId: "can-tho-school-001", schoolName: "Trường THCS Ninh Kiều", wardId: "can-tho-31135", code: "NK-MAIN", name: "Trường THCS Ninh Kiều", address: "Phường An Hòa, TP. Cần Thơ", position: [10.0348, 105.7702], isMainCampus: true, status: "active" },
